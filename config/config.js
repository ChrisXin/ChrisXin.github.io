...
( function(winkstart, amplify, $) {
    ...
    winkstart.config =  {
        ...
        onboard_roles: {
            'default': {
                apps: {
                    voip: {
                        label: 'Hosted PBX',
                        icon: 'phone',
                        api_url: 'http://cloud.sxu.ca:8000/v1' //'http://cloud.sxu.ca:8000/v1'
                    },
                    pbxs: {
                        label: 'PBX Connector',
                        icon: 'device',
                ...
                default_api_url: 'http://cloud.sxu.ca:8000/v1' //'http://cloud.sxu.ca:8000/v1'
            },
            'reseller': {
                apps: {
                    voip: {
            ...
            'small_office': {
                ...
                available_apps: ['voip', 'cluster', 'userportal', 'accounts', 'developer', 'numbers', 'pbxs'],
                default_api_url: 'http://cloud.sxu.ca:8000/v1'
            },
            'single_phone': {
                apps: {
                    voip: {
        ...
        default_api_url: 'http://cloud.sxu.ca:8000/v1', //'https://api.zswitch.net:8443/v1',
    ...
    winkstart.apps = {
        'auth' : {
            api_url: 'http://cloud.sxu.ca:8000/v2' //'https://api.zswitch.net:8443/v1',
